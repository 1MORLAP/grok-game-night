...
Open on phone-sized viewport (or desktop). You must enter a name on the gate screen before the app opens (cannot be skipped, per original spec). Enter **Tomasz** (or “tomasz!” etc.) on one device to test admin controls.
